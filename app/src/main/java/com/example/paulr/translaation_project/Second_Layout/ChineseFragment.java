...
public class ChineseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView wordC = v.findViewById(R.id.WordChinese);
        TextView defenitionC = v.findViewById(R.id.BackgroundChinese);
        wordC.setText(mParam1);
        defenitionC.setText(mParam2);
        return v;
    }
